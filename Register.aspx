			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				...
				<form id="form1" runat="server" class="login100-form validate-form" >
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
                        ...
                        <input id="password" type="password" class="input100" type="password" name="pass"  placeholder="*************" />
					...
					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
                            ...
                            <asp:Button ID="signup" runat="server" Text="Sign up" class="btn-outline-dark btn-primary login100-form-btn" OnClick="signup_Click"   />
